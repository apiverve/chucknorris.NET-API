...
namespace APIVerve
{
    public class ChuckNorrisJokesAPIClient
    {
        ...
        public ChuckNorrisJokesAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public ChuckNorrisJokesAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, chucknorrisQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(chucknorrisQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(chucknorrisQueryOptions options)
        {
